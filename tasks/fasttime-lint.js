    ...
    function (grunt)
    {
        grunt.registerMultiTask(
            ...
            function ()
            {
                ...
                {
                    grunt.warn('Validation not available in Node.js < 4');
                    return;
                }
                var opts =
                    this.options(
                ...
                var jscsConfig = { options: opts.jscsRules };
                jscsConfig[target] = files;
                grunt.config.set('jscs', jscsConfig);
                grunt.task.run(['eslint', 'jscs']);
            }
        );
    };
